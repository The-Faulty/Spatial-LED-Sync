...
class CinematicSpillGUI:
    ...
    def _build_wave_tab(self) -> None:
        ...
        self._field(waves, 9, "Front Ambient Coverage", "front_ambient_coverage", float)
        self._combo(waves, 10, "Front Ambient Source", "front_ambient_source", ["top_strip", "average"])
        self._field(waves, 11, "Top Strip Height", "front_ambient_top_height", float)
        self._field(waves, 12, "Top Strip Blur", "front_ambient_blur", int)
    ...
    def _build_preview_tab(self) -> None:
        ...
        self._slider(threshold_frame, 5, "Ambient Coverage", "front_ambient_coverage", 0.0, 1.0)
        self._slider(threshold_frame, 6, "Flash Area", "flash_changed_fraction", 0.0, 1.0)
        self._slider(threshold_frame, 7, "Explosion Spike", "explosion_brightness_spike", 0.0, 1.0)
        self._slider(threshold_frame, 8, "Camera Pan", "camera_pan_confidence", 0.0, 1.0)
        self._slider(threshold_frame, 9, "Min Motion", "min_motion", 0.0, 0.1)
